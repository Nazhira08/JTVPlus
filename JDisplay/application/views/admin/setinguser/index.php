    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
          <div class="panel-heading">                                
            <h4 class="panel-title"></h4><a href="<?=site_url('setinguser/tambah/');?>"><button type="button" class="btn btn-warning btn-sm">Tambah data</button></a>
         ...
         <div class="panel-body">
          <table  class="table datatable">
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group">
                        <a href="<?=site_url('setinguser/update/'.$row->id_user);?>" class="btn btn-sm bg-teal" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-pencil"></i></a>
                        <a href="<?=site_url('setinguser/delete/'.$row->id_user);?>" class="btn btn-sm bg-teal" data-toggle="tooltip" data-original-title="delete"><i class="fa fa-trash-o"></i></a>
                    </div>
                </td>          
            </tr>
            <?php } ?>
