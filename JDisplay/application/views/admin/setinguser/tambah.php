            ...
            <div class="block">
               <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input style="width: 400px"  readonly="yes" required autofocus placeholder="Username" type="text" class="form-control" name="ftp_user" value="<?=$query['ftp_user']?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label">FTP Password</label>
                        <div class="col-md-9">
                            <input style="width: 400px"  readonly="yes" required autofocus placeholder="Username" type="text" class="form-control" name="ftp_password" value="<?=$query['ftp_pass']?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label">FTP Path</label>
                        <div class="col-md-9">
                            <input style="width: 400px"  readonly="yes" required autofocus placeholder="Username" type="text" class="form-control" name="ftp_path" value="<?=$query['ftp_home']?>">
                        </div>
                    </div>         
                    <div class="form-group">
