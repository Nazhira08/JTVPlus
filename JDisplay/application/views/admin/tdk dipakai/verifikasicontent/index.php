 ...
 <!-- START BREADCRUMB -->
                ...
                <div class="content-frame">   
                    ...
                    <div class="content-frame-top">                        
                        <div class="page-title">                    
                            <h2><span class="fa fa-foursquare"></span> Non Verifikasi Video Dijadikan Verifikasi Video</h2>
                        </div>                                                         
                    </div>
                    ...
                    <div class="content-frame-right">                                           
                        ...
                        <div class="list-group border-bottom push-down-20">
                             ...
                             <a href="<?php site_url('Verifikasicontent')?>?TVnya=<?php echo $row->TVnya; ?>" class="list-group-item"><?= $row->TVnya;?> <span class="badge badge-success"><?= $row->jumlahnya;?></span></a>
                             <?php }?>
                        </div>                                                
                    </div>
                    ...
                    <div class="content-frame-body content-frame-body-left">
                        ...
                        <div class="gallery" id="links">
                            ...
                            <?php $no=0; foreach ($query->result() as $row) { $no++ ?> 
                             <?php $download=site_url('Verifikasicontent/Download?urutan=').$row->urutan; ?>
                        ...
                        <ul class="pagination pagination-sm pull-right push-down-20 push-up-20">
                            <?php if($pos>0) { ?>
                            <li><a href="<?php site_url('Verifikasicontent')?>?search=<?php echo $search; ?>&TVnya=<?php echo $TVnya; ?>&pos=<?php echo $pos; ?>">«</a></li>
                            <?php } ?>
                            
                            <?php for($i=1;$i<=$jum_query;$i++) { ?> 
                            <li <?php if($i==$pos+1) echo 'class="active"'; ?>><a href="<?php site_url('Verifikasicontent')?>?search=<?php echo $search; ?>&TVnya=<?php echo $TVnya; ?>&pos=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                            <?php }?>
                            ...
                            <li><a href="<?php site_url('Verifikasicontent')?>?search=<?php echo $search; ?>&TVnya=<?php echo $TVnya; ?>&pos=<?php echo $pos+2; ?>">»</a></li>
                             <?php }?>
                        </ul>
                    </div>       
         ...
         <div class="message-box message-box-info animated fadeIn" id="myModal" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static">
            <div class="mb-container">
                <div class="mb-middle">
                    <div class="mb-footer">
                    <?=form_open_multipart($action, array('role' => 'form', 'class'=>'form-horizontal form-bordered'));?> 
                    <a href=<?php site_url('Verifikasicontent')?>?search=<?php echo $search; ?>&TVnya=<?php echo $TVnya; ?>&pos=<?php echo $pos+1; ?> class="btn btn-warning"  id="btn-yes" ><span class="fa fa-times-circle"></span> &nbsp;&nbsp;Close</a>    
                    <a href="" class="btn btn-default"  id="btn-download" ><span class="fa fa-download"></span> &nbsp;&nbsp;Cek Video File</a>                   
                     <button  type="submit" class="btn btn-danger" name="save" value="simpan"><span class="fa fa-shopping-cart"></span> Video ini Verifikasi </button>
     ...
     function set_url(url) {
             ...
             function set_url2(url) {
                ...
                xmlhttp.open("GET","<?=site_url('Verifikasicontent/berita?urutan=');?>" + JsVar,true);   // ini untuk di pass ke script php nya
