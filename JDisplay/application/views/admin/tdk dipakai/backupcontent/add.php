        ...
        <div class="col-xs-12">
            ...
            <div class="block">
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <input  required autofocus placeholder="Label Storage" type="text" class="form-control" name="nama_storage">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label">Jenis Storage</label>
                        <div class="col-md-7">
                            <input required autofocus placeholder="jenis" type="text" class="form-control" name="jenis_storage">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label">Kapasitas</label>
                        <div class="col-md-1">
                            <input required autofocus placeholder="capacity" type="text" class="form-control" name="capacity"> 
                        </div>
                        <div class="col-md-1">
                            <B>Gigabyte</B>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input required autofocus placeholder="serial" type="text" class="form-control" name="sn">
                        </div>
                    </div>
