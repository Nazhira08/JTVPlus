                ...
                <div class="content-frame">                                    
                    ...
                    <div class="content-frame-top">                        
                        <div class="page-title">                    
                            <h2><span class="fa fa-inbox"></span> SO / MO <small>(3 unread)</small></h2>
                        </div>                                                                                
                    </div>
                    ...
                    <div class="content-frame-left">
                        <div class="block">
                            <div class="list-group border-bottom">
                                <a href="<?=site_url('editor');?>" class="list-group-item active"><span class="fa fa-inbox"></span> Baru <span class="badge badge-success">3</span></a>
                                <a href="<?=site_url('editor');?>" class="list-group-item"><span class="fa fa-star"></span> Lama <span class="badge badge-warning">6</span></a>                            
                            </div>                        
                        </div>
                    </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <table class="table table-bordered table-striped">
                                    <tr>
                                        <th width="50">type</th><th>name</th>
                                    </tr>
