<?php defined('BASEPATH') OR exit('No direct script access allowed');?>
    ...
    <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Whitelist IP</h2>
    </div>
        ...
        <div class="col-xs-12">
            ...
            <div class="block">
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <input  required autofocus placeholder="ip" type="text" class="form-control" name="ip" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label">Alasan</label>
                        <div class="col-md-7">
                            <input required autofocus placeholder="alasan" type="text" class="form-control" name="alasan">
                        </div>
                    </div>
