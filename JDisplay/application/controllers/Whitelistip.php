...
class Whitelistip extends MY_Controller {
  ...
  public function __construct() {
    ...
    if (cari_hak_akses($this->session->userdata('username'),'Whitelistip')=="0") redirect('dashboard');
    ...
    $this->data['id_menu']=  $this->db->select('id')->where("site",'Whitelistip')->get('menu')->result_array()[0]['id'];
    $this->data['id_menu_awal']=  $this->db->select('tree_menu')->where("site",'Setinguser')->get('menu')->result_array()[0]['tree_menu'];
  } 
  ...
  public function index()
  {
    ...
    $this->data['konten'] = 'admin/whitelistip/index';
